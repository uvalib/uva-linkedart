<xsl:stylesheet xmlns="http://www.loc.gov/mods/v3" xmlns:marc="http://www.loc.gov/MARC21/slim" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" exclude-result-prefixes="xlink marc" version="1.0">
	...
	MODS 3.7  (Revision 1.141) 20241003
	
	Revision 1.141 - 005 insert "T" between date and time for ISO-8601:2019 compliance. 2024/10/03 ntra
	...
	<xsl:template match="/">
		<xsl:choose>
			...
			<xsl:otherwise>
				<mods xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="3.7" xsi:schemaLocation="http://www.loc.gov/mods/v3 http://www.loc.gov/standards/mods/v3/mods-3-7.xsd">
...
<!--				voyager timestamp:20010702132215.0 simple tests; assumes a timestamp -->
			...
			<recordOrigin>Converted from MARCXML to MODS version 3.7 using MARC21slim2MODS3-7.xsl
				(Revision 1.141 20241003)</recordOrigin>
